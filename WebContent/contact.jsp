		...
		<div id="header">
			<div id="section">
				<div
					...
					<h3>A project by Harshita Chaudhary</h3>
				</div>
			</div>
			<ul>
			...
			<center>
				<div id="tagline">
					<div>
						<h2 style="height: 0px;">Indira Gandhi Open University </h2>
						<br> 1st Floor, DEC Building, IGNOU, Maidan Garhi, New Delhi - 110068<br>
						<br> Name: Harshita Chaudhary<br> ID: 185542244<br> Email: <a
							href="mailto:harshita16300@gmail.com">harshita16300@gmail.com</a>
					</div>
				</div>
			</center>
		</div>
